                  ...
                  <div key={slideIndex} className="w-full shrink-0">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
                      <a
                        ...
                        className="group relative block aspect-video overflow-hidden rounded-lg shadow-xl"
                      >
                        <Image
                      ...
                      <div className="flex flex-col justify-center text-center lg:text-left">
                        <h3 className={`text-2xl font-normal tracking-tight text-zinc-900 sm:text-3xl dark:text-white ${strongGlasgow.className}`}>
                          {slide.title}
                        </h3>
                        ...
                        <div className="mt-6">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center text-base font-medium text-zinc-900 dark:text-white"
                          >
